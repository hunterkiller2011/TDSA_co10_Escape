...
if(isClass(configFile >> "CfgPatches" >> "air_f_vietnam_04_c")) then {							//check if Nickel Steel mod is loaded
		...
		a3e_arr_PrisonBackpackWeapons pushback ["vnx_c96","vnx_c96_mag"];
		a3e_arr_PrisonBackpackWeapons pushback ["vnx_p08","vnx_p08_mag"];
		a3e_arr_PrisonBackpackWeapons pushback ["vnx_m77e_shorty","vnx_m77e_so_mag"];
	};
...
switch (_enemyFrequency) do {
    case 1: {//Few (1-3)
		...
		,"vn_o_wheeled_btr40_mg_04"	//sgm
		,"vn_o_wheeled_btr40_mg_05"	//type56 rr
		,"vn_o_wheeled_btr40_mg_06"	//mortar
		,"vn_o_armor_btr50pk_01"	//transport
		,"vn_o_armor_btr50pk_02"	//zgu-1 aa
		,"vn_o_armor_btr50pk_03"	//ambulance
		...
		if(isClass(configFile >> "CfgPatches" >> "air_f_vietnam_04_c")) then {							//check if Nickel Steel mod is loaded
			a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses_IND pushback "vnx_o_wheeled_tuktuk_01_vc";
			a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses_IND pushback "vnx_o_wheeled_tuktuk_mg_01_vc";
			a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses_IND pushback "vnx_o_wheeled_tuktuk_mg_02_vc";
		};
    };
    case 2: {//Some (4-6)
        a3e_arr_Escape_MilitaryTraffic_EnemyVehicleClasses = [
...
a3e_arr_Escape_InfantryTypes = [
	...
	,"vn_o_men_nva_07" //Grenadier KBKG
	,"vn_o_men_nva_07" //Grenadier KBKG
	...
	,"vn_o_men_nva_45"	//Marksman VZ54
	,"vn_o_men_nva_47"	//Marksman SVD
	,"vn_o_men_nva_49"	//Rifleman AK
...
a3e_arr_Escape_RoadBlock_MannedVehicleTypes_Ind = [
	...
	if(isClass(configFile >> "CfgPatches" >> "air_f_vietnam_04_c")) then {							//check if Nickel Steel mod is loaded
		a3e_arr_Escape_RoadBlock_MannedVehicleTypes_Ind pushback "vnx_o_wheeled_tuktuk_mg_01_vc";
		a3e_arr_Escape_RoadBlock_MannedVehicleTypes_Ind pushback "vnx_o_wheeled_tuktuk_mg_02_vc";
	};
...
a3e_arr_Escape_ReinforcementTruck_vehicleClasses_Ind = [
	...
	,"vn_o_wheeled_z157_02_vcmf"];
	if(isClass(configFile >> "CfgPatches" >> "air_f_vietnam_04_c")) then {							//check if Nickel Steel mod is loaded
		a3e_arr_Escape_ReinforcementTruck_vehicleClasses_Ind pushback "vnx_o_wheeled_tuktuk_01_vc";
	};
...
a3e_arr_ComCenStaticWeapons = [
	...
	,"vn_o_nva_static_m1910_high_01"
	,"vn_o_vc_static_mg42_high"];
	if(isClass(configFile >> "CfgPatches" >> "air_f_vietnam_04_c")) then {							//check if Nickel Steel mod is loaded
		a3e_arr_ComCenStaticWeapons pushback "vn_o_nva_static_dp28_high";
	};
...
a3e_arr_Escape_AmmoDepot_StaticWeaponClasses = [
	...
	,"vn_o_nva_navy_static_zgu1_01"];
	if(isClass(configFile >> "CfgPatches" >> "air_f_vietnam_04_c")) then {							//check if Nickel Steel mod is loaded
		a3e_arr_Escape_AmmoDepot_StaticWeaponClasses pushback "vn_o_nva_static_dp28_high";
	};
...
a3e_arr_Escape_AmmoDepot_ParkedVehicleClasses = [
	...
	,"vn_o_wheeled_z157_mg_02"];
	if(isClass(configFile >> "CfgPatches" >> "air_f_vietnam_04_c")) then {							//check if Nickel Steel mod is loaded
		a3e_arr_Escape_EnemyCivilianCarTypes pushback "vnx_o_wheeled_tuktuk_mg_01_vc";
		a3e_arr_Escape_EnemyCivilianCarTypes pushback "vnx_o_wheeled_tuktuk_mg_02_vc";
	};
...
a3e_arr_AmmoDepotBasicWeapons pushback ["vn_ak_01", 20, 2, 4, ["vn_type56_mag"], 8];
a3e_arr_AmmoDepotBasicWeapons pushback ["vn_kbkg", 25, 2, 4, ["vn_kbkg_mag"], 12];
a3e_arr_AmmoDepotBasicWeapons pushback ["vn_kbkg_gl", 25, 2, 4, ["vn_kbkg_mag","vn_20mm_f1n60_frag_mag","vn_20mm_pgn60_heat_mag","vn_20mm_dgn_wp_mag"], 10];
...
a3e_arr_AmmoDepotBasicWeapons pushback ["vn_k98k", 50, 4, 8, ["vn_k98k_mag"], 10];
// non-CSAT weapons
...
a3e_arr_AmmoDepotBasicWeapons pushback ["vn_m1903", 30, 1, 3, ["vn_m1903_mag"], 10];
...
a3e_arr_AmmoDepotBasicWeapons pushback ["vn_m36", 30, 2, 4, ["vn_m36_mag"], 8];
...
if(isClass(configFile >> "CfgPatches" >> "air_f_vietnam_04_c")) then {							//check if Nickel Steel mod is loaded
		a3e_arr_AmmoDepotBasicWeapons pushback ["vnx_m12_smg", 20, 1, 2, ["vnx_m12_smg_32_mag"], 8];
		a3e_arr_AmmoDepotBasicWeapons pushback ["vnx_m12_smg", 20, 1, 2, ["vnx_m12_smg_20_t_mag"], 8];
		a3e_arr_AmmoDepotBasicWeapons pushback ["vnx_m50_smg", 30, 1, 2, ["vnx_m50_smg_t_mag"], 8];
		a3e_arr_AmmoDepotBasicWeapons pushback ["vnx_m38_smg", 20, 1, 2, ["vnx_m38_smg_32_mag"], 10];
		a3e_arr_AmmoDepotBasicWeapons pushback ["vnx_stg44", 30, 1, 2, ["vnx_stg44_mag"], 10];
		a3e_arr_AmmoDepotBasicWeapons pushback ["vnx_no4", 20, 1, 2, ["vnx_no4_t_mag"], 12];
		a3e_arr_AmmoDepotBasicWeapons pushback ["vnx_p08", 20, 1, 2, ["vnx_p08_mag"], 4];
	};
...
a3e_arr_AmmoDepotSpecialWeapons pushback ["vn_svd_sniper", 30, 2, 4, ["vn_svd_mag"], 10];
a3e_arr_AmmoDepotSpecialWeapons pushback ["vn_k98k_mrk_camo", 30, 2, 4, ["vn_k98k_mag"], 10];
...
a3e_arr_AmmoDepotSpecialWeapons pushback ["vn_m1903_sniper", 20, 2, 4, ["vn_m1903_mag"], 10];
a3e_arr_AmmoDepotSpecialWeapons pushback ["vn_m1903_gl", 30, 2, 4, ["vn_m1903_t_mag","vn_22mm_he_mag"], 10];
...
a3e_arr_AmmoDepotSpecialWeapons pushback ["vn_mg42", 30, 2, 4, ["vn_mg42_50_t_mag"], 6];
...
if(isClass(configFile >> "CfgPatches" >> "air_f_vietnam_04_c")) then {							//check if Nickel Steel mod is loaded
		a3e_arr_AmmoDepotSpecialWeapons pushback ["vnx_fm2429", 30, 1, 3, ["vnx_fm2429_t_mag"], 8];
		a3e_arr_AmmoDepotSpecialWeapons pushback ["vnx_tul1", 30, 1, 3, ["vnx_rpk_40_t_mag"], 8];
		a3e_arr_AmmoDepotSpecialWeapons pushback ["vnx_tul1", 30, 1, 3, ["vnx_rpk_75_t_mag"], 5];
		a3e_arr_AmmoDepotSpecialWeapons pushback ["vnx_no4_sniper", 30, 1, 3, ["vnx_no4_mag"], 12];
	};
...
a3e_arr_AmmoDepotVehicle pushback [objNull, 50, 1, 1, ["vn_20mm_f1n60_frag_mag","vn_20mm_kgn_frag_mag","vn_20mm_pgn60_heat_mag"], 20];
a3e_arr_AmmoDepotVehicle pushback [objNull, 25, 1, 1, ["vn_20mm_dgn_wp_mag"], 10];
...
a3e_arr_AmmoDepotItems pushback ["vn_o_3x_sks", 20, 1, 2]; //SKS scope
a3e_arr_AmmoDepotItems pushback ["vn_o_3x_m9130", 20, 1, 2]; //M9130 scope
...
a3e_arr_AmmoDepotItems pushback ["vn_b_m1903", 20, 1, 5]; //bayonet
a3e_arr_AmmoDepotItems pushback ["vn_o_8x_m1903", 20, 1, 5]; //scope
a3e_arr_AmmoDepotItems pushback ["vn_b_camo_m1903", 20, 1, 5]; //camo
a3e_arr_AmmoDepotItems pushback ["vn_b_m36", 20, 1, 5]; //bayonet
a3e_arr_AmmoDepotItems pushback ["vn_b_camo_m36", 20, 1, 5]; //camo
a3e_arr_AmmoDepotItems pushback ["vn_b_k98k", 20, 1, 5]; //bayonet
a3e_arr_AmmoDepotItems pushback ["vn_o_1_5x_k98k", 20, 1, 5]; //scope
a3e_arr_AmmoDepotItems pushback ["vn_b_camo_k98k", 20, 1, 5]; //camo
/*if(A3E_Param_NoNightvision==0) then {
...
if(isClass(configFile >> "CfgPatches" >> "air_f_vietnam_04_c")) then {							//check if Nickel Steel mod is loaded
		a3e_arr_AmmoDepotItems pushback ["vnx_o_aa_fm2429", 20, 1, 5]; //aa sight
		a3e_arr_AmmoDepotItems pushback ["vnx_b_no4", 20, 1, 5]; //bayonet
	};
...
a3e_arr_CivilianCarWeapons pushback ["vn_l4", "vn_l1a1_30_t_mag", 7];
a3e_arr_CivilianCarWeapons pushback ["vn_f1_smg", "vn_f1_smg_mag", 8];
a3e_arr_CivilianCarWeapons pushback ["vn_l34a1_f", "vn_f1_smg_mag", 8];
a3e_arr_CivilianCarWeapons pushback ["vn_l2a3_f", "vn_f1_smg_t_mag", 8];
...
if(isClass(configFile >> "CfgPatches" >> "air_f_vietnam_04_c")) then {							//check if Nickel Steel mod is loaded
		...
		a3e_arr_CivilianCarWeapons pushback ["vnx_no4","vnx_no4_mag", 10];
		a3e_arr_CivilianCarWeapons pushback ["vnx_c96","vnx_c96_mag", 4];
	};
...
a3e_arr_extraction_chopper = [
	...
	,"vn_b_air_ch47_02_01"];
	if(isClass(configFile >> "CfgPatches" >> "air_f_vietnam_04_c")) then {							//check if Nickel Steel mod is loaded
		a3e_arr_extraction_chopper pushback "vnx_b_air_hh1h_04_01";
		a3e_arr_extraction_chopper pushback "vnx_b_air_hh1h_02_01";
		a3e_arr_extraction_chopper pushback "vnx_b_air_hh34_01_01";
	};
...
a3e_arr_extraction_car = [
	...
	,"vn_b_armor_m113_01"];	//
	if(isClass(configFile >> "CfgPatches" >> "air_f_vietnam_04_c")) then {							//check if Nickel Steel mod is loaded
		a3e_arr_extraction_car pushback "vnx_b_armor_lvtp5_01";
	};
a3e_arr_extraction_car_escort = [
	...
	,"vn_b_armor_m48_01_02"];
	if(isClass(configFile >> "CfgPatches" >> "air_f_vietnam_04_c")) then {							//check if Nickel Steel mod is loaded
		a3e_arr_extraction_car_escort pushback "vnx_b_armor_m163_01";
		a3e_arr_extraction_car_escort pushback "vnx_b_armor_m50_01";
		a3e_arr_extraction_car_escort pushback "vnx_b_armor_m50a1_01";
	};
...
if(isClass(configFile >> "CfgPatches" >> "air_f_vietnam_04_c")) then {
	...
	a3e_arr_CrashSiteWrecks pushback "vnx_air_a4e_01_wreck";
	a3e_arr_CrashSiteWrecks pushback "vnx_air_ov10a_01_wreck";
	};
...
a3e_arr_CrashSiteWrecksCar = [
	...
	,"vn_armor_m67_wreck"];
if(isClass(configFile >> "CfgPatches" >> "air_f_vietnam_04_c")) then {
	a3e_arr_CrashSiteWrecksCar pushback "vnx_armor_lvte1_wreck";
	a3e_arr_CrashSiteWrecksCar pushback "vnx_armor_m163_wreck";
	a3e_arr_CrashSiteWrecksCar pushback "vnx_armor_m50_wreck";
	};
...
a3e_arr_CrashSiteWeapons pushback ["vn_m20a1b1_01", 30, 1, 2, ["vn_m20a1b1_heat_mag","vn_m20a1b1_wp_mag"], 2];
...
a3e_arr_CrashSiteWeapons pushback ["vn_m1carbine_shorty", 40, 1, 2, ["vn_hp_mag"], 12];
a3e_arr_CrashSiteWeapons pushback ["vn_m1carbine_shorty", 10, 2, 4, ["vn_hp_mag"], 10];
...
a3e_arr_CrashSiteWeapons pushback ["vn_xm177_m203_camo", 50, 2, 4, ["vn_m16_30_t_mag", "vn_40mm_m406_he_mag", "vn_40mm_m661_flare_g_mag"], 6];
a3e_arr_CrashSiteWeapons pushback ["vn_m14a1_shorty", 30, 1, 2, ["vn_m14_t_mag"], 10];
...
if(isClass(configFile >> "CfgPatches" >> "air_f_vietnam_04_c")) then {							//check if Nickel Steel mod is loaded
		a3e_arr_CrashSiteWeapons pushback ["vnx_m45_sf", 30, 1, 2, ["vn_m45_mag"], 8];
		a3e_arr_CrashSiteWeapons pushback ["vnx_m77e", 30, 1, 2, ["vnx_m77e_fl_mag","vnx_m77e_buck_mag"], 12];
		a3e_arr_CrashSiteWeapons pushback ["vnx_type56_xm148", 30, 1, 2, ["vn_type56_mag","vn_40mm_m381_he_mag","vn_40mm_m397_ab_mag","vn_40mm_m651_cs_mag","vn_40mm_m661_flare_g_mag"], 4];
		a3e_arr_CrashSiteWeapons pushback ["vnx_m201z", 30, 1, 2, ["vnx_37mm_cs_mag","vnx_37mm_cs_fin_mag","vnx_37mm_cs_skat_mag","vnx_37mm_baton_mag","vnx_37mm_flare_mag"], 6];
	};
...
if(isClass(configFile >> "CfgPatches" >> "air_f_vietnam_04_c")) then {							//check if Nickel Steel mod is loaded
		a3e_arr_CrashSiteItems pushback ["vn_s_m45_camo", 20, 1, 2];
		a3e_arr_CrashSiteItems pushback ["vn_s_m45", 20, 1, 2];
	};


//New stuff for VN

A3E_Trap_Classes = [["random","vn_mine_punji_03"],["random","vn_mine_punji_01"],["random","vn_mine_punji_02"],["roadside","vn_mine_jerrycan_range"],["roadside","vn_mine_bike_range"],["center","vn_mine_gboard"],["center","vn_mine_tripwire_f1_04"]];//,["roadcenter","vn_mine_tripwire_m16_04"],["roadcenter","vn_mine_tripwire_arty"],["roadside","vn_mine_tripwire_f1_02"]]; Classnames ofd traps and mines. String or array in form [classname, trigger range, scriptcode]
