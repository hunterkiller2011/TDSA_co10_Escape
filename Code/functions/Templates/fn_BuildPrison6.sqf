...
_obj = "Wall_bis_HBarrier5_01" createVehicleLocal _pos;
_obj setVectorDirAndUp [[0,1,0],[0,0,1]];
_obj setdir ((getdir _obj) + _rotation);
_obj setPosATL _pos;
...
_obj = "Land_Fire_barrel" createVehicleLocal _pos;
_obj setVectorDirAndUp [[1,-4.37114e-08,0],[0,0,1]];
_obj setdir ((getdir _obj) + _rotation);
_obj setPosATL _pos;

_pos = [_center,_center vectorAdd [-6.2,-.3,0],_rotation] call A3E_fnc_rotatePosition;
_obj = "Land_PortableLight_single_F" createVehicleLocal _pos;
...
_obj = "Land_Net_FenceD_8m_F" createVehicleLocal _pos;
_obj setVectorDirAndUp [[1,-4.37114e-08,0],[0,0,1]];
_obj setdir ((getdir _obj) + _rotation);
_obj setPosATL _pos;

_pos = [_center,_center vectorAdd [-10.8,-1.6,0],_rotation] call A3E_fnc_rotatePosition;
_obj = "Land_Net_Fence_8m_F" createVehicleLocal _pos;
_obj setVectorDirAndUp [[1,-4.37114e-08,0],[0,0,1]];
_obj setdir ((getdir _obj) + _rotation);
_obj setPosATL _pos;
...
_obj = "Land_Net_Fence_4m_F" createVehicleLocal _pos;
_obj setVectorDirAndUp [[-1,1.19249e-08,0],[0,0,1]];
_obj setdir ((getdir _obj) + _rotation);
_obj setPosATL _pos;
...
_obj = "Land_CampingChair_V2_white_F" createVehicleLocal _pos;
...
_obj = "Land_ChairPlastic_F" createVehicleLocal _pos;
...
_obj = "Land_Campfire_burning" createVehicleLocal _pos;
_obj setVectorDirAndUp [[0,1,0],[0,0,1]];
_obj setdir ((getdir _obj) + _rotation);
_obj setPosATL _pos;
